...
UPDSAsync_GetWeapons* UDreamAsyncProxy::CreatePDSAsyncGetWeapons(UObject* WorldContextObject, EGetWeaponCondition Condition)
{
...
UPDSAsync_SwitchWeapon* UDreamAsyncProxy::CreatePDSAsyncSwitchWeapon(UObject* WorldContextObject, int32 WeaponId, int32 EquipmentIndex)
{
...
UPDSAsync_RunServer* UDreamAsyncProxy::CreatePDSAsyncRunServer(UObject* WorldContextObject, const FRunServerParameter& Parameter)
{
...
UPDSAsync_AddWeapon* UDreamAsyncProxy::CreatePDSAsyncAddWeapon(UObject* WorldContextObject, TArray<FPlayerWeaponAdd> NewWeapons)
{
...
UPDSAsync_PayItem* UDreamAsyncProxy::CreatePDSAsyncPayItem(UObject* WorldContextObject, int64 ItemId)
{
...
UPDSAsync_GetStoreItems* UDreamAsyncProxy::CreatePDSAsyncGetStoreItems(UObject* WorldContextObject, int32 StoreId)
{
...
UPDSAsync_GetPlayerInfo* UDreamAsyncProxy::CreatePDSAsyncGetPlayerInfo(UObject* WorldContextObject)
{
...
UPDSAsync_Login* UDreamAsyncProxy::CreatePDSAsyncLogin(UObject* WorldContextObject)
{
