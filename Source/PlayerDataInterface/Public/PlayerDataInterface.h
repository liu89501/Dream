...
DECLARE_MULTICAST_DELEGATE_TwoParams(FGetStoreItemsComplete, const TArray<FDItemInfo>&, const FString& /*ErrorMessage*/);
...
class PLAYERDATAINTERFACE_API FPlayerDataInterface
{

public:

	FPlayerDataInterface(IOnlineSubsystem* OSSystem);
	~FPlayerDataInterface();
